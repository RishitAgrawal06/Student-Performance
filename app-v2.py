...
#st.subheader("These graphs below show the various results of students with variables altering their performance. Students are being more challenged with today's society \\n ")")

col1, col2, col3 = st.columns(3)
with col1: 
    st.write('Math v. Writing Scores')
...
#st.subheader("Rigors of students backgrounds are tested through the means of exams... Through this dataset we have compared the ")
